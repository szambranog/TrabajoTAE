...
#df[c('P756S1', 'P756S2', 'P5667')][is.na(df[c('P756S1', 'P756S2', 'P5667', 'P6087', 'P6088')])] <- 'na'
...
Para el nivel de satisfacción de lxs niñxs, se llenó esta columna con el valor medio (5), por lo que no nos da información del nivel de satisfacción según la encuesta
...
```{r}
res <- cor(df[c('P1895', 'P1896', 'P1897', 'P1898', 'P1899', 'P3175')])
corrplot(res, type = 'upper', tl.col = 'black', tl.srt=45, sig.level=0.5, insig='blank', method='pie', addCoef.col = 'black')
```
Vemos que las las variables con mayor correlación son **Satisfacción de Vida** con **Satisfacción Salud** (66%) y **Satisfacción Vida** con **Satisfacción Tiempo libre** (62%)
...
\listoffigures figuritas
\listoftables tablitas